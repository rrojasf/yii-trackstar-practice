...
class m160226_204746_create_issue_user_and_assignment_tables extends CDbMigration
{
	public function up()
	{
	}
	...
	{
		echo "m160226_204746_create_issue_user_and_assignment_tables does not support migration down.\n";
		return false;
	}
